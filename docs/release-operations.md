...
3. Run the ordinary local checks and review the complete diff, including
   ...
   `git add -- project.yml docs/releases/0.1.11.md`. If the release includes
   ...
   create the commit with `git commit -m 'build(release): prepare v0.1.11 build 12'`.
...
6. Push only that tag: `git push origin v0.1.11`. This starts the release CI
