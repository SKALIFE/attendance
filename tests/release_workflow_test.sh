...
RELEASE_NOTES="$ROOT/docs/releases/0.1.3.md"
...
[ -f "$RELEASE_NOTES" ] || fail 'v0.1.3 Korean release notes are missing.'
grep -Fq '# SKALA Attendance 0.1.3' "$RELEASE_NOTES" || fail 'Release notes must identify v0.1.3.'
