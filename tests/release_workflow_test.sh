...
RELEASE_NOTES="$ROOT/docs/releases/0.1.5.md"
...
[ -f "$RELEASE_NOTES" ] || fail 'v0.1.5 Korean release notes are missing.'
grep -Fq '# SKALA Attendance 0.1.5' "$RELEASE_NOTES" || fail 'Release notes must identify v0.1.5.'
