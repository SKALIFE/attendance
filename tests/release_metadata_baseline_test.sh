...
assert_contains "$PROJECT" 'MARKETING_VERSION: "0.1.0"'
assert_contains "$PROJECT" 'CURRENT_PROJECT_VERSION: "1"'
...
printf 'Baseline metadata fixture matches marketing version 0.1.0 and build 1.\n'
